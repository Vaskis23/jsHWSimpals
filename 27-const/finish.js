...
//Надо заменить const на let потому что в строке 20 идет новое присваевание переменной arr.
//При объявлении переменной с использованием const, ее значение не может быть переназначено.
